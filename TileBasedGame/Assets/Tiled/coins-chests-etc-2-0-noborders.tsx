...
<tileset version="1.10" tiledversion="1.11.0" name="coins-chests-etc-2-0-noborders" tilewidth="16" tileheight="16" tilecount="3705" columns="57">
 <image source="../Textures/tilesets/coins-chests-etc-2-0-noborders.png" width="912" height="1040"/>
 <tile id="61">
  <properties>
   <property name="Coin.value" type="int" value="10"/>
